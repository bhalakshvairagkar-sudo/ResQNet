...
source_image_path = r"C:\Users\BHALAKSH VAIRAGKAR\.gemini\antigravity\brain\b06dc8c6-52c0-49df-9c40-4092152a0815\.user_uploaded\media_1788262836633.jpg"
...
for res_dir in target_res_dirs:
    ...
    # Remove conflicting xml / webp files
    for old_webp in glob.glob(os.path.join(res_dir, "mipmap-*", "*.webp")):
        try:
            os.remove(old_webp)
            print(f"Removed duplicate: {old_webp}")
    ...
    if os.path.exists(old_fg_xml):
        try:
            ...
            print(f"Removed old vector: {old_fg_xml}")
        except Exception:
            pass
...
print("Clean Icon Generation Completed Successfully!")
